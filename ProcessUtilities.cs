...
{
	//based on Ctrl+C & Ctrl+V from https://stackoverflow.com/a/16142791/7600726
	...
	public static class ProcessUtilities
	{
		...
		public static string GetCommandLine(this Process process)
		{
			...
			return GetProcessParametersString(process.Id, Environment.Is64BitOperatingSystem ? 0x70 : 0x40);
		}
