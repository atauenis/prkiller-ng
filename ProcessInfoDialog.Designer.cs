...
namespace prkiller_ng
{
	partial class ProcessInfoDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtDescriptionCopyright = new System.Windows.Forms.TextBox();
			this.txtDescriptionVersion = new System.Windows.Forms.TextBox();
			this.txtProcessExtraInfo = new System.Windows.Forms.TextBox();
			this.txtProcImageName = new System.Windows.Forms.TextBox();
			this.txtProcWorkingDir = new System.Windows.Forms.TextBox();
			this.txtProcCmdLine = new System.Windows.Forms.TextBox();
			this.lblFileDesc = new System.Windows.Forms.Label();
			this.lblFileCompany = new System.Windows.Forms.Label();
			this.lblFileCopyright = new System.Windows.Forms.Label();
			...
			this.tableLayoutPanel1.Controls.Add(this.txtDescriptionCompany, 2, 1);
			this.tableLayoutPanel1.Controls.Add(this.txtDescriptionCopyright, 2, 2);
			this.tableLayoutPanel1.Controls.Add(this.txtDescriptionVersion, 2, 3);
			this.tableLayoutPanel1.Controls.Add(this.txtProcessExtraInfo, 2, 5);
			this.tableLayoutPanel1.Controls.Add(this.txtProcImageName, 2, 6);
			this.tableLayoutPanel1.Controls.Add(this.txtProcWorkingDir, 2, 7);
			this.tableLayoutPanel1.Controls.Add(this.txtProcCmdLine, 2, 8);
			this.tableLayoutPanel1.Controls.Add(this.lblFileDesc, 1, 0);
			this.tableLayoutPanel1.Controls.Add(this.lblFileCompany, 1, 1);
			this.tableLayoutPanel1.Controls.Add(this.lblFileCopyright, 1, 2);
			this.tableLayoutPanel1.Controls.Add(this.lblFileVersion, 1, 3);
			this.tableLayoutPanel1.Controls.Add(this.lblProcExtra, 1, 5);
			...
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 23F));
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 23F));
			this.tableLayoutPanel1.Size = new System.Drawing.Size(445, 207);
			...
			this.txtDescription.Size = new System.Drawing.Size(369, 23);
			...
			this.txtDescriptionCompany.Size = new System.Drawing.Size(369, 23);
			this.txtDescriptionCompany.TabIndex = 0;
			this.txtDescriptionCompany.WordWrap = false;
			// 
			// txtDescriptionCopyright
			// 
			...
			this.txtDescriptionCopyright.Size = new System.Drawing.Size(369, 23);
			this.txtDescriptionCopyright.TabIndex = 0;
			this.txtDescriptionCopyright.WordWrap = false;
			// 
			...
			this.txtDescriptionVersion.Size = new System.Drawing.Size(369, 23);
			this.txtDescriptionVersion.TabIndex = 0;
			...
			this.txtProcessExtraInfo.Size = new System.Drawing.Size(369, 23);
			this.txtProcessExtraInfo.TabIndex = 0;
			this.txtProcessExtraInfo.WordWrap = false;
			// 
			// txtProcImageName
			// 
			...
			this.txtProcImageName.Size = new System.Drawing.Size(369, 23);
			this.txtProcImageName.TabIndex = 0;
			this.txtProcImageName.WordWrap = false;
			// 
			// txtProcWorkingDir
			// 
			...
			this.txtProcWorkingDir.Size = new System.Drawing.Size(369, 23);
			this.txtProcWorkingDir.TabIndex = 0;
			this.txtProcWorkingDir.WordWrap = false;
			// 
			// txtProcCmdLine
			// 
			...
			this.txtProcCmdLine.Size = new System.Drawing.Size(369, 23);
			this.txtProcCmdLine.TabIndex = 0;
			this.txtProcCmdLine.WordWrap = false;
			// 
			// lblFileDesc
			// 
			...
			this.lblFileCompany.Text = "label1";
			// 
			// lblFileCopyright
			// 
			...
			this.lblFileCopyright.Text = "label1";
			// 
			// lblFileVersion
			// 
			...
			this.lblFileVersion.Text = "label1";
			// 
			// lblProcExtra
			// 
		...
		internal System.Windows.Forms.TextBox txtDescriptionCompany;
		internal System.Windows.Forms.TextBox txtDescriptionCopyright;
		internal System.Windows.Forms.TextBox txtDescriptionVersion;
		internal System.Windows.Forms.TextBox txtProcImageName;
		internal System.Windows.Forms.TextBox txtProcWorkingDir;
		internal System.Windows.Forms.TextBox txtProcCmdLine;
		internal System.Windows.Forms.TextBox txtProcessExtraInfo;
		private System.Windows.Forms.Label lblFileDesc;
		private System.Windows.Forms.Label lblFileCompany;
		private System.Windows.Forms.Label lblFileCopyright;
		private System.Windows.Forms.Label lblFileVersion;
		private System.Windows.Forms.Label lblProcExtra;
